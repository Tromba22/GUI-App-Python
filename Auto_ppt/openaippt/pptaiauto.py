...
class PresentationApp:
    ...
    def generate_images(self):
        try:
            ...
            num_images = int(self.number_slider.get())

            if num_images < 1:
                messagebox.showerror("Error", "Number of images to generate must be at least 1.")
                return
    ...
    def choose_and_add_image(self):
        if self.image_type.cget("text") == "Imported":
            ...
            picture = self.generated_images[self.current_image_index]
            picture = ImageTk.getimage( picture )
...
if __name__ == "__main__":
    ...
    root.tk.call("source", "C://Users//alitr//Downloads//azure.tcl")
